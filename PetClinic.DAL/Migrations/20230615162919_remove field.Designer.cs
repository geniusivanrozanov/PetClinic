...
namespace PetClinic.DAL.Migrations
{
    ...
    [Migration("20230615162919_remove field")]
            ...
            modelBuilder.Entity("PetClinic.DAL.Entities.DepartmentEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 6, 15, 4, 29, 18, 0, DateTimeKind.Utc),
                            IsDeleted = false,
                            Name = "Вет-клиника филиал 1",
                            UpdatedAt = new DateTime(2023, 6, 15, 4, 29, 18, 0, DateTimeKind.Utc)
                        },
                        new
                        {
            ...
            modelBuilder.Entity("PetClinic.DAL.Entities.RoleEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "99954212-7546-496e-bfd4-20fbbb6e66bd",
                            CreatedAt = new DateTime(2023, 6, 15, 4, 29, 18, 0, DateTimeKind.Utc),
                            IsDeleted = false,
                            Name = "Admin",
                            UpdatedAt = new DateTime(2023, 6, 15, 4, 29, 18, 0, DateTimeKind.Utc)
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "14938563-d80f-4edb-b8e4-5f382480f244",
                            CreatedAt = new DateTime(2023, 6, 15, 4, 29, 18, 0, DateTimeKind.Utc),
                            IsDeleted = false,
                            Name = "Client",
                            UpdatedAt = new DateTime(2023, 6, 15, 4, 29, 18, 0, DateTimeKind.Utc)
